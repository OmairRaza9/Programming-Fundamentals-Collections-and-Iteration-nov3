...
phone << row_4
p phone
#3hash that has a name, a continent, and whether or not it is an island.
puts "+++++++++++++++++++++++++++++++++++++++++++"
globe = [{:continent => "North America",:name => "Canada",   :island => "not_island"},
         {:continent => "North America",:name => "Cuba",     :island => "island"},
         {:continent => "Asia"         ,:name => "Pakistan", :island => "not_island"}]
# country = {}
#
# country[canada]   = ["north_america", "not_island"]
# country[cuba]     = ["north_america", "island"]
# country[pakistan] = ["asia", "not_island"]
#
# globe << country
